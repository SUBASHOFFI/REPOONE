      ...
      <div className='HEADS'>
        <div className='Top_NavBar'>
          <ul>
            ...
            <li><a href="#Loan Status" onClick={USERSTATUSS}>Loan Status</a></li>
            {/* <li><a href="#Profile" onClick={GOPROFILE}>Profile</a></li> */}
